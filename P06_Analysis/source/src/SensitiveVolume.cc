  ...
  void SensitiveVolume::EndOfEvent(G4HCofThisEvent*)
{
   ...
   analysisManager->FillH1(0, sum_eDep_1);
   analysisManager->FillH1(1, sum_stepLength_1);
   analysisManager->FillH1(2, sum_eDep_2);
   analysisManager->FillH1(3, sum_stepLength_2);
